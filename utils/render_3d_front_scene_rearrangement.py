...
def render_3d_front_scene(args):
    ...
    scene1_dir = "/idas/users/cuiliyuan/NeRFSceneUnderstanding/data/new_blend/scene.blend"
    loaded_objects = bproc.loader.load_blend(scene1_dir, obj_types=['mesh', 'curve', 'hair', 'armature',
                                               'empty', 'light', 'camera'])
