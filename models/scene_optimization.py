...
class SceneOptimization(SceneEstimationModule):
    ...
    def optimize_scene(self, est_scene, gt_scene, skip_stage=None):
        ...
        with torch.enable_grad(), torch.inference_mode(False):
            ...
            latent_code_temple = est_scene['object'][0]['latent_code']
            for obj in est_scene['object'].values():
                obj['latent_code'] = latent_code_temple
                print(id(obj['latent_code']), id(latent_code_temple))
